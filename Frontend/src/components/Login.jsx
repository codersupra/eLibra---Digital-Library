...
function Login() {
  ...
  return (
    <>
      {/* <Navbar /> */}
      <h1 className='text-6xl font-bold  relative left-40 my-4'>Login</h1>
      <div className="container border-2 bg-transparent flex flex-row justify-between mx-auto my-2 rounded-lg w-4/5 h-fit py-3 px-5 shadow-lg">
        <div className="signup w-3/5 p-1 duration-100 hover:shadow-lg rounded-lg">
          <div className='text-5xl font-bold my-2'>Welcome Back!</div>
          <h1 className='text-2xl font-bold'>Login to your Account</h1>
          <div className='mx-1 my-2 w-3/5'>
            <h1 className='text-xs py-1'>Login up via</h1>
          ...
          <hr />
          <div className='text-xs my-2'>Login via email</div>
          <form action="" onSubmit={handleSubmit(onSubmit)} className='mx-auto flex flex-col gap-2'>
            ...
            <div><button className='btn rounded-lg py-1 px-1 w-3/4 my-2 mx-auto bg-black text-white hover:bg-slate-900 duration-150'>Login<input type="submit" value="" onClick={() => { }} /></button></div>
          </form>
          <div className="log text-xs">Don't have an account? <span className='underline'><a href="/">Sign up</a></span></div>
        </div>
        <div className=' w-2/4'>
          <img src='./download.jpg' alt="Image" className='mx-auto'></img>
        </div>
